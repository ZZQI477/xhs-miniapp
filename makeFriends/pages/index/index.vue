  ...
  <view class="container">
          ...
          <view class="user-card">
            ...
            <view class="section" v-if="user.my_tags && user.my_tags.length > 0">
              ...
              <view class="tags-wrap">
                <text class="tag" v-for="(tag, idx) in user.my_tags" :key="idx">{{ tag }}</text>
              </view>
            </view>
            ...
            <view class="section">
              ...
              <view class="detail-grid">
                ...
                <view class="detail-item" v-if="user.hometown_city">
                  ...
                  <text class="detail-value">{{ user.hometown_province }}{{ user.hometown_city }}</text>
                </view>
            ...
            <view class="section" v-if="user.ideal_intro || (user.ideal_tags && user.ideal_tags.length > 0)">
              ...
              <view class="tags-wrap" v-if="user.ideal_tags && user.ideal_tags.length > 0">
                <text class="tag " v-for="(tag, idx) in user.ideal_tags" :key="idx">{{ tag }}</text>
              </view>
            </view>
    ...
    <view class="side-actions" v-if="users.length > 0 && currentUser">
      <view class="action-item" @click="handleFollow">
          ...
          <!-- <text class="action-label">{{ currentUser.is_followed ? '已关注' : '关注' }}</text> -->
        </view>
