...
function getLocaleLanguage$1() {
  let localeLanguage = "";
  {
    localeLanguage = normalizeLocale(xhs.getSystemInfoSync().language) || LOCALE_EN;
  }
...
const offError = {
  args(fromArgs) {
    ...
    if (!app.$vm) {
      ...
      const index2 = xhs.$onErrorHandlers.findIndex((fn) => fn === fromArgs);
      if (index2 !== -1) {
        xhs.$onErrorHandlers.splice(index2, 1);
      }
...
function initUni(api, protocols2, platform = xhs) {
