...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    e: common_vendor.o((...args) => $options.goLogin && $options.goLogin(...args), "2e")
  } : {
    f: $data.userInfo.avatar || "/static/logo.png",
    g: common_assets._imports_1$2,
    h: common_assets._imports_2$1,
    i: $data.userInfo.avatar || "/static/logo.png",
    j: common_vendor.o((...args) => $options.changeAvatar && $options.changeAvatar(...args), "13"),
    ...
    D: common_assets._imports_11$1,
    E: common_assets._imports_10$1,
