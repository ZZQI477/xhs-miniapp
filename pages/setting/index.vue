<template>
  <view class="container">
    ...
    <view class="setting-list">
      ...
      <navigator class="setting-item" url="/pages/about/index">
        ...
        <view class="version-container">
          <text class="version-text">v1.6.41</text>
          <text class="arrow-icon">→</text>
        </view>
      </navigator>
	  ...
	  <!-- 退出登录 -->
      <navigator class="setting-item" url="JavaScript:;" @click="loginout">
    ...
    <view class="privacy-policy">
		<text class="policy-text" @click.stop="openUserAgreement">《用户协议》</text>
		<text class="policy-text" @click.stop="openPrivacyPolicy">《隐私协议》</text>
		<!-- // todo:完善协议 -->
