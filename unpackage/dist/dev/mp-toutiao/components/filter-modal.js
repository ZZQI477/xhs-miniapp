  ...
  return common_vendor.e({
    ...
    c: common_vendor.f($data.ageOptions, (item, k0, i0) => {
      return {
        ...
        c: item.value,
        d: common_vendor.o(($event) => $data.filterData.ageRange = item.value, "80")
      };
    }),
    d: common_vendor.f($data.heightOptions, (item, k0, i0) => {
      return {
        ...
        c: item.value,
        d: common_vendor.o(($event) => $data.filterData.heightRange = item.value, "9d")
      };
    }),
...
//# sourceMappingURL=../../.sourcemap/mp-toutiao/components/filter-modal.js.map
