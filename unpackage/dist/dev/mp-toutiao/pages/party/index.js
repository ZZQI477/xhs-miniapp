...
const _sfc_main = {
  ...
  methods: {
    ...
    goPartyDetail(id) {
      common_vendor.index.__f__("log", "at pages/party/index.vue:92", "id:", id);
  ...
  async onShow() {
    ...
    common_vendor.index.__f__("log", "at pages/party/index.vue:110", res);
    if (res.code == 1) {
      common_vendor.index.__f__("log", "at pages/party/index.vue:112", res.data.list);
  ...
  return {
    ...
    b: common_vendor.f($data.activities, (item, index, i0) => {
      return common_vendor.e({
        ...
        o: common_vendor.o(($event) => $options.handleAction(item), "ac")
      } : {}, {
        p: index,
        q: common_vendor.o(($event) => $options.goPartyDetail(item.partyid), "fc")
      });
    })
  };
}
...
//# sourceMappingURL=../../../.sourcemap/mp-toutiao/pages/party/index.js.map
