  ...
  methods: {
    ...
    async loadQuestions() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/soul/questions.vue:98", "加载问题失败", e);
      }
    },
    // 加载我的灵魂问答
    async loadMySoul() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/soul/questions.vue:117", "加载灵魂问答失败", e);
      }
    },
    // 显示问题选择器
  ...
  return common_vendor.e({
    ...
    c: common_vendor.f($data.soulAnswers, (item, index, i0) => {
      return {
        ...
        c: common_vendor.o(($event) => $options.showQuestionPicker(index), "28"),
        d: item.answer,
        e: common_vendor.o(($event) => item.answer = $event.detail.value, "15"),
        f: index
      };
    }),
...
//# sourceMappingURL=../../../.sourcemap/mp-toutiao/pages/soul/questions.js.map
