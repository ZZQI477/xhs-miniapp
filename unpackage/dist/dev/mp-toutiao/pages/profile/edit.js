  ...
  methods: {
    ...
    async loadUserInfo() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/profile/edit.vue:311", "加载用户信息失败", e);
    ...
    async loadTags() {
      try {
        ...
        common_vendor.index.__f__("error", "at pages/profile/edit.vue:324", "加载标签失败", e);
      }
    },
    // 选择属性
    selectProperty(type) {
    ...
    async nextStep() {
      ...
      if (this.currentStep === 4) {
        ...
        common_vendor.index.__f__("log", "at pages/profile/edit.vue:480", this.form);
        this.currentStep++;
      }
    },
    // 保存资料
  ...
  return common_vendor.e({
    ...
    x: common_vendor.f($options.displayImages, (img, index, i0) => {
      return common_vendor.e({
        ...
        g: index,
        h: common_vendor.o(($event) => img ? $options.previewImage(index) : $options.chooseImage(), "ae")
      });
    })
  }) : {}, {
    ...
    G: common_vendor.f($data.allTags, (tag, k0, i0) => {
      return {
        ...
        d: common_vendor.o(($event) => $options.toggleTag("my_tags", tag.name), "46")
      };
    })
  } : {}, {
    ...
    P: common_vendor.f($data.allTags, (tag, k0, i0) => {
      return {
        ...
        d: common_vendor.o(($event) => $options.toggleTag("ideal_tags", tag.name), "c6")
      };
    })
  } : {}, {
...
//# sourceMappingURL=../../../.sourcemap/mp-toutiao/pages/profile/edit.js.map
