  ...
  methods: {
    ...
    async loadData() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/request/index.vue:252", "加载失败", e);
  ...
  return common_vendor.e({
    ...
    h: common_vendor.f($data.subTabs, (tab, index, i0) => {
      return {
        ...
        d: common_vendor.o(($event) => $options.switchSubTab(index), "8e")
      };
    }),
    ...
    l: common_vendor.f($data.list, (item, k0, i0) => {
      return common_vendor.e({
        ...
        j: common_vendor.o(($event) => $options.goDetail(item.from_user.id), "e0"),
        k: item.status === "pending"
      }, item.status === "pending" ? {
        l: common_vendor.o(($event) => $options.handleAction(item.id, "reject"), "1b"),
        m: common_vendor.o(($event) => $options.handleAction(item.id, "accept"), "5d")
      } : common_vendor.e({
    ...
    n: common_vendor.f($data.list, (item, k0, i0) => {
      return common_vendor.e({
        ...
        k: common_vendor.o(($event) => $options.goDetail(item.target_user.id), "43"),
        l: item.status === "accepted"
      }, item.status === "accepted" ? {
        m: common_vendor.o(($event) => $options.viewWechat(item.target_user.id), "7d")
      } : {
...
//# sourceMappingURL=../../../.sourcemap/mp-toutiao/pages/request/index.js.map
