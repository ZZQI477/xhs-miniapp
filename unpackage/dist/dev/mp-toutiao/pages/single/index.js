  ...
  return common_vendor.e({
    ...
    D: common_vendor.f($data.users, (user, index, i0) => {
      return common_vendor.e({
        ...
        e: common_vendor.o(($event) => $options.onImageLoad(user.id), "2c"),
        f: common_vendor.o(($event) => $options.onImageError(user.id), "de"),
        ...
        m: user.education,
        o: user.id,
        p: common_vendor.o(($event) => $options.goUserDetail(user.id), "d7")
      });
    }),
    E: $data.showUnlock
