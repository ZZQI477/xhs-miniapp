...
const _sfc_main = {
  ...
  methods: {
    toCasesDetail(id) {
      common_vendor.index.__f__("log", "at pages/cases/index.vue:49", "id:", id);
  ...
  async onShow() {
    ...
    common_vendor.index.__f__("log", "at pages/cases/index.vue:57", res);
    if (res.code == 1) {
      common_vendor.index.__f__("log", "at pages/cases/index.vue:59", res.data.list);
  ...
  return {
    ...
    b: common_vendor.f($data.casesList, (item, index, i0) => {
      return common_vendor.e({
        ...
        g: index,
        h: common_vendor.o(($event) => $options.toCasesDetail(item.caseid), "5c")
      });
    })
  };
}
...
//# sourceMappingURL=../../../.sourcemap/mp-toutiao/pages/cases/index.js.map
