  ...
  methods: {
    async loadData() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/group/index.vue:96", "加载失败", e);
      } finally {
        this.loading = false;
      }
    },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.f($data.list, (item, index, i0) => {
      return {
        a: item.qrcode || "https://minixhs.chugao520.com/makefriends/logo.png",
    ...
    d: !$data.loading,
    e: common_vendor.o((...args) => $options.goSingle && $options.goSingle(...args), "19"),
    f: common_vendor.o((...args) => $options.joinGroupFree && $options.joinGroupFree(...args), "4e"),
    g: $data.showQrcode
  }, $data.showQrcode ? {
    h: $data.currentQrcode,
    i: common_vendor.o((...args) => $options.goSingle && $options.goSingle(...args), "e9"),
    j: common_vendor.o(() => {
    }, "65"),
    k: common_vendor.o(($event) => $data.showQrcode = false, "e3")
  } : {});
}
