  ...
  methods: {
    async loadConversations() {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/chat/list.vue:167", "[ChatList] 加载会话列表失败", e);
    ...
    handleNewMessage(message) {
      common_vendor.index.__f__("log", "at pages/chat/list.vue:189", "[ChatList] 收到新消息", message);
