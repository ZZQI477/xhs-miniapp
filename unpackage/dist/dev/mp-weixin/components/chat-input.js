  ...
  methods: {
    ...
    chooseImage() {
      ...
      common_vendor.index.chooseImage({
        ...
        fail: (err) => {
          common_vendor.index.__f__("error", "at components/chat-input.vue:137", "[ChatInput] 选择图片失败", err);
        }
      });
    },
    sendWechatCard() {
...
//# sourceMappingURL=../../.sourcemap/mp-weixin/components/chat-input.js.map
