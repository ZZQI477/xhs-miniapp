...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    m: common_vendor.o((...args) => $options.onBannerAnimationFinish && $options.onBannerAnimationFinish(...args), "99"),
    n: common_vendor.o((...args) => $options.onBannerTouchStart && $options.onBannerTouchStart(...args), "59"),
    o: common_vendor.o((...args) => $options.onBannerTouchEnd && $options.onBannerTouchEnd(...args), "2e")
  } : {}, {
    ...
    s: common_vendor.o(($event) => $options.switchTab(0), "5d"),
    t: $data.currentTab === 1 ? 1 : "",
    v: common_vendor.o(($event) => $options.switchTab(1), "25"),
    w: $data.currentTab !== 2
  }, $data.currentTab !== 2 ? {
    x: common_vendor.o(($event) => $data.showFilterModal = true, "17")
  } : {}, {
    y: $data.currentTab !== 2
  }, $data.currentTab !== 2 ? common_vendor.e({
    z: common_vendor.f($data.users, (user, index, i0) => {
      return common_vendor.e({
    ...
    B: $data.extraUsers.length > 0
  }, $data.extraUsers.length > 0 ? {
    C: common_vendor.f($data.extraUsers.slice(0, 5), (user, idx, i0) => {
      return {
    ...
    D: common_vendor.o((...args) => $options.handleUnlockClick && $options.handleUnlockClick(...args), "9b")
  }) : {}) : {}, {
    E: $data.currentTab === 2
  }, $data.currentTab === 2 ? {
    F: common_vendor.f($data.coupleList, (item, index, i0) => {
      return {
        a: item.avatar,
    ...
    H: common_vendor.t($data.loading ? "加载中..." : "加载更多"),
    I: common_vendor.o((...args) => $options.loadMore && $options.loadMore(...args), "09")
  } : {}, {
    J: !$data.loading && $options.currentList.length === 0
