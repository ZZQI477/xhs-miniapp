  ...
  return common_vendor.e({
    a: common_vendor.f($data.tabs, (tab, k0, i0) => {
      return common_vendor.e({
        ...
        f: common_vendor.o(($event) => $options.switchTab(tab.type), tab.type)
      });
    }),
    ...
    f: common_vendor.f($data.list, (item, k0, i0) => {
      return common_vendor.e({
        ...
        k: common_vendor.o(($event) => $options.copyWechat(item.extra.wechat), item.id)
      } : {}, {
        l: item.from_user
      }, item.from_user ? {
        ...
        q: item.id,
        r: !item.is_read ? 1 : "",
        s: common_vendor.o(($event) => $options.handleClick(item), item.id)
      });
    })
  }, {
